...
//        Postgres sql statment below
//        final String sql"SELECT r.name FROM app_user_role ur INNER JOIN app_role r ON ur.app_role_id = r.app_role_id INNER JOIN app_user au ON ur.app_user_id = au.app_user_id WHERE au.username = ?;"
